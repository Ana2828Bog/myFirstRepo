...
public class BaseSetup {
	...
	public BaseSetup() {
		...
		try {
			...
			System.out.println("Failed for load enviriment context. check possible file path errors");
			e.printStackTrace();
			throw new RuntimeException("Failed for Load enviriment context with message" + e.getMessage());
		}
